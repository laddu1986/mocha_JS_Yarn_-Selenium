import Home from '../page_objects/homePage';
import SignIn from '../page_objects/signInPage';// test/web/page_objects/createAccountPage.js
...
describe('Open Sign in page', () => {
  ...
  it('Shows a positive number of results', () => {
    ...
    const actual = SignIn.signInMessage.getText();
