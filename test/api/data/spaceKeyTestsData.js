...
export const blankStatusPatch = {
  api: `${keys}${lib.spaceKeyNegData.orgID}/keys/${lib.spaceKeyNegData.spaceKeyValue}?rowVersion=${
    lib.spaceKeyNegData.spaceKeyRowVersion
  }`,
  data: [
    {
      op: 'replace',
...
export const incorrectKeyPatch = {
  api: `${keys}${lib.spaceKeyNegData.orgID}/keys/${lib.spaceKeyNegData.orgID}?rowVersion=${
    lib.spaceKeyNegData.spaceKeyRowVersion
  }`,
  data: [
    {
...
export const incorrectOrgIdPatch = {
  api: `${keys}${lib.spaceKeyNegData.identityID}/keys/${lib.spaceKeyNegData.spaceKeyValue}?rowVersion=${
    lib.spaceKeyNegData.spaceKeyRowVersion
  }`,
  data: [
    {
